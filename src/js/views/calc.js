		...
		<div className="text-center mt-5">
			...
			<p>
				<h3> Account Size </h3>
					...
					<sub>{"Example: entering 150 would calculate to $150"}</sub><li>
					...
					<sub> {"Example: entering 1 will calculate at 1%"} </sub><li>
				...
				<h3> Profit Target </h3>
					...
					<sub>{"Example: entering 5 would mean your sell-target is set 5% above purchase."}</sub><li>
					<input
						type="text"
						name="profitTarget"
				...
				<h3> Invalidation Point </h3>
					...
					<sub>{"Example: entering 5 would mean your stop loss is set 5% below purchase."}</sub><li>
					<input
						type="text"
